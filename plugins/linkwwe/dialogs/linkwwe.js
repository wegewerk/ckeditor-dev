...
CKEDITOR.dialog.add( 'linkwwe', function( editor ) {
	var plugin = CKEDITOR.plugins.linkwwe;
	...
	var targetChanged = function() {
			...
			switch ( value ) {
				case 'frame':
					targetName.setLabel( editor.lang.linkwwe.targetFrameName );
					targetName.getElement().show();
					break;
				case 'popup':
					popupFeatures.show();
					targetName.setLabel( editor.lang.linkwwe.targetPopupName );
					targetName.getElement().show();
					break;
				default:
	...
	var parseLink = function( editor, element ) {
			...
			if ( !retval.type ) {
				...
				// Protected email link as encoded string.
					...
					bodyMatch && ( email.body = decodeURIComponent( bodyMatch[ 1 ] ) );
                                ...
                                else if ( typeof href != 'undefined' && ( pageMatch = href.match( pageRegex ) ) ) {
					retval.type = 'page';
					retval.page = {};
			...
			if ( element ) {
				...
				CKEDITOR.plugins.linkwwe.synAnchorSelector ? retval.adv.advCSSClasses = getLinkClass( element ) : advAttr( 'advCSSClasses', 'class' );
	...
	return {
					...
					children: [
					{
						...
						onLoad: function() {
							...
							$input.get(0).ondrop = function(ev) {
								...
								getAjaxLink ( this.value, 'pagename' );
								return false;
							}
						...
						onKeyUp: function() {
							getAjaxLink ( this.getValue(), 'pagename' );
							this.allowOnChange = true;
						},
						onChange: function() {
						...
						validate: function() {
							...
							var func = CKEDITOR.dialog.validate.notEmpty( linkLang.noPage );
		...
		onOk: function() {
			...
			switch ( data.type || 'url' ) {
                            	case 'page':
					attributes[ 'data-cke-saved-href' ] = data.page.href;
					break;
				case 'url':
